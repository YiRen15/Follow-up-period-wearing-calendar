...
set "WORK_DIR=%~dp0"
set "JAR_PATH=%~dp0target\Follow-up-period-wearing-calendar-Fupwc-1.00.01-jar-with-dependencies.jar"
...
echo 期待路径：%JAR_PATH%
echo 请确保 target 目录下包含 Follow-up-period-wearing-calendar-Fupwc-1.00.01-jar-with-dependencies.jar
echo.
pause
exit /b 1
